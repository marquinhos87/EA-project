...
<div class="col-md-12">
    <form class="mt-2" method="post" action="${pageContext.request.contextPath}\SearchPersonalTrainer">
        <div class="form-group row">
            ...
            <div class="col-md-1">
                <input type="number" pattern="\d+(.\d\d)" min="0" class="form-control" name="minprice" placeholder="Preço mínimo">
            </div>
            <div class="col-md-1">
                <input type="number" pattern="\d+(.\d\d)" min="0" class="form-control" name="maxprice" placeholder="Preço máximo">
            </div>
            <div class="col-md-2">
    ...
    <%} else {%>
        <div class="alert alert-warning" role="alert">
            <h4 class="alert-heading">Without Personal Trainers yet.</h4>
