...
public class Client implements hrclient.IClient {
	...
	private java.util.Set this_getSet (int key) {
		if (key == hrclient.ORMConstants.KEY_CLIENT_BIOMETRICDATAS) {
	...
	public final hrclient.BiometricDataSetCollection biometricDatas = new hrclient.BiometricDataSetCollection(this, _ormAdapter, hrclient.ORMConstants.KEY_CLIENT_BIOMETRICDATAS, hrclient.ORMConstants.KEY_MUL_ONE_TO_MANY);
