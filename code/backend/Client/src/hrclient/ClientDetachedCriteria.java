...
public class ClientDetachedCriteria extends AbstractORMDetachedCriteria {
	...
	public hrclient.BiometricDataDetachedCriteria createBiometricDatasCriteria() {
		return new hrclient.BiometricDataDetachedCriteria(createCriteria("ORM_BiometricDatas"));
	}
