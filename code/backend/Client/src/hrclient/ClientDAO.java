...
public class ClientDAO {
	public static Client loadClientByORMID(String username) throws PersistentException {
		try {
			PersistentSession session = hrclient.DiagramasPersistentManager.instance().getSession();
	...
	public static Client loadClientByORMID(PersistentSession session, String username) throws PersistentException {
		try {
			return (Client) session.load(hrclient.Client.class, username);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Client getClientByORMID(PersistentSession session, String username) throws PersistentException {
		try {
			return (Client) session.get(hrclient.Client.class, username);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Client loadClientByORMID(PersistentSession session, String username, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Client) session.load(hrclient.Client.class, username, lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Client getClientByORMID(PersistentSession session, String username, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Client) session.get(hrclient.Client.class, username, lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static List queryClient(PersistentSession session, String condition, String orderBy) throws PersistentException {
		StringBuffer sb = new StringBuffer("From hrclient.Client as Client");
		if (condition != null)
	...
	public static Client createClient() {
		return new hrclient.Client();
	}
	
	public static boolean save(hrclient.Client client) throws PersistentException {
		try {
			hrclient.DiagramasPersistentManager.instance().saveObject(client);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(hrclient.Client client) throws PersistentException {
		try {
			hrclient.DiagramasPersistentManager.instance().deleteObject(client);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean refresh(hrclient.Client client) throws PersistentException {
		try {
			hrclient.DiagramasPersistentManager.instance().getSession().refresh(client);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(hrclient.Client client) throws PersistentException {
		try {
			hrclient.DiagramasPersistentManager.instance().getSession().evict(client);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
