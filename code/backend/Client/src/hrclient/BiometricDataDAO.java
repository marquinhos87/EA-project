...
public class BiometricDataDAO {
	...
	public static boolean save(hrclient.BiometricData biometricData) throws PersistentException {
		try {
			hrclient.DiagramasPersistentManager.instance().saveObject(biometricData);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(hrclient.BiometricData biometricData) throws PersistentException {
		try {
			hrclient.DiagramasPersistentManager.instance().deleteObject(biometricData);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean refresh(hrclient.BiometricData biometricData) throws PersistentException {
		try {
			hrclient.DiagramasPersistentManager.instance().getSession().refresh(biometricData);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(hrclient.BiometricData biometricData) throws PersistentException {
		try {
			hrclient.DiagramasPersistentManager.instance().getSession().evict(biometricData);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
