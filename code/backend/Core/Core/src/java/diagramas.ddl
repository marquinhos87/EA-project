CREATE TABLE `Plan` (ID int(10) NOT NULL AUTO_INCREMENT, WeekID int(10) NOT NULL, PersonalTrainerUsername varchar(255) NOT NULL, Done tinyint(1), Modified tinyint(1) NOT NULL, InitialDate date, PRIMARY KEY (ID));
...
ALTER TABLE `Plan` ADD CONSTRAINT FKPlan658559 FOREIGN KEY (WeekID) REFERENCES Week (ID);
