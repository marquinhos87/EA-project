...
public class UserDAO {
	public static User loadUserByORMID(String username) throws PersistentException {
		try {
			PersistentSession session = hrpersonaltrainer.DiagramasPersistentManager.instance().getSession();
			return loadUserByORMID(session, username);
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static User getUserByORMID(String username) throws PersistentException {
		try {
			PersistentSession session = hrpersonaltrainer.DiagramasPersistentManager.instance().getSession();
			return getUserByORMID(session, username);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static User loadUserByORMID(String username, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			PersistentSession session = hrpersonaltrainer.DiagramasPersistentManager.instance().getSession();
			return loadUserByORMID(session, username, lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static User getUserByORMID(String username, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			PersistentSession session = hrpersonaltrainer.DiagramasPersistentManager.instance().getSession();
			return getUserByORMID(session, username, lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static User loadUserByORMID(PersistentSession session, String username) throws PersistentException {
		try {
			return (User) session.load(hrpersonaltrainer.User.class, username);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static User getUserByORMID(PersistentSession session, String username) throws PersistentException {
		try {
			return (User) session.get(hrpersonaltrainer.User.class, username);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static User loadUserByORMID(PersistentSession session, String username, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (User) session.load(hrpersonaltrainer.User.class, username, lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static User getUserByORMID(PersistentSession session, String username, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (User) session.get(hrpersonaltrainer.User.class, username, lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static List queryUser(PersistentSession session, String condition, String orderBy) throws PersistentException {
		StringBuffer sb = new StringBuffer("From hrpersonaltrainer.User as User");
		if (condition != null)
	...
	public static User createUser() {
		return new hrpersonaltrainer.User();
	}
	
	public static boolean save(hrpersonaltrainer.User user) throws PersistentException {
		try {
			hrpersonaltrainer.DiagramasPersistentManager.instance().saveObject(user);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(hrpersonaltrainer.User user) throws PersistentException {
		try {
			hrpersonaltrainer.DiagramasPersistentManager.instance().deleteObject(user);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean refresh(hrpersonaltrainer.User user) throws PersistentException {
		try {
			hrpersonaltrainer.DiagramasPersistentManager.instance().getSession().refresh(user);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(hrpersonaltrainer.User user) throws PersistentException {
		try {
			hrpersonaltrainer.DiagramasPersistentManager.instance().getSession().evict(user);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
