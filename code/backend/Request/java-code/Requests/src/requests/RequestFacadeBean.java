...
public class RequestFacadeBean implements RequestFacadeBeanLocal {
    ...
    public void updateUserToken(String usernameAndTokenAsJson) throws JsonKeyInFaultException, TokenIsInvalidException, UserDoesNotExistException, PersistentException {
        ...
        User user = null;
        if((user = UserDAO.getUserByORMID(username)) == null) throw new UserDoesNotExistException();
    ...
    public void createClient(String usernameAndTokenAsJSon) throws JsonKeyInFaultException, PersistentException, UserAlreadyExistsException, ClientAlreadyExistsException {
        ...
        if(UserDAO.getUserByORMID(username) != null) throw new UserAlreadyExistsException(username);
     ...
     */
    public void createPersonalTrainer(String usernameAndTokenAsJSon) throws JsonKeyInFaultException, PersistentException, UserAlreadyExistsException, PersonalTrainerDoesNotExistException, PersonalTrainerAlreadyExistsException {
        JsonObject json = Utils.validateJson(gson , usernameAndTokenAsJSon , Arrays.asList("username", "token"));
        String username = json.get("username").getAsString(), token = json.get("token").getAsString();
        User user;PersonalTrainer personalTrainer;
        if(UserDAO.getUserByORMID(username) != null) throw new UserAlreadyExistsException(username);
        if(PersonalTrainerDAO.getPersonalTrainerByORMID(username) != null) throw new PersonalTrainerAlreadyExistsException(username);
        user = new User();
        user.setUsername(username);
        user.setToken(token);
        UserDAO.save(user);
    ...
    public void submitRequest(String requestInfoAsJSON) throws JsonKeyInFaultException, TokenIsInvalidException, UserDoesNotExistException, PersistentException, ClientDoesNotExistException, PersonalTrainerDoesNotExistException {
        ...
        if((pt = PersonalTrainerDAO.getPersonalTrainerByORMID(personalTrainer)) == null) throw new PersonalTrainerDoesNotExistException(personalTrainer);
    ...
    public void replyToRequest(String requestIdAndResponseAsJSON) throws JsonKeyInFaultException, PersistentException, PersonalTrainerDoesNotExistException, RequestDoesNotExistException, UserDoesNotExistException, TokenIsInvalidException {
        ...
        if(PersonalTrainerDAO.getPersonalTrainerByORMID(username) == null) throw new PersonalTrainerDoesNotExistException(username);
        Request request;
        if((request = RequestDAO.getRequestByORMID(requestId)) == null) throw new RequestDoesNotExistException(String.valueOf(requestId));
    ...
    public String listClientRequestsByPersonalTrainer(String usernameAsJSON) throws JsonKeyInFaultException, TokenIsInvalidException, UserDoesNotExistException, PersistentException, PersonalTrainerDoesNotExistException {
        ...
        if((personalTrainer = PersonalTrainerDAO.getPersonalTrainerByORMID(username)) == null) throw new PersonalTrainerDoesNotExistException(username);
