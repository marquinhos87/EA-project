...
public class Utils {
    ...
    public static void validateToken(String token, String username) throws TokenIsInvalidException, PersistentException, UserDoesNotExistException {
        User user;
        if((user = UserDAO.getUserByORMID(username)) == null) throw new UserDoesNotExistException(username);
