...
public class ClientDAO {
	...
	public static Client loadClientByORMID(PersistentSession session, String username) throws PersistentException {
		try {
			return (Client) session.load(requests.Client.class, username);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Client getClientByORMID(PersistentSession session, String username) throws PersistentException {
		try {
			return (Client) session.get(requests.Client.class, username);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Client loadClientByORMID(PersistentSession session, String username, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Client) session.load(requests.Client.class, username, lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Client getClientByORMID(PersistentSession session, String username, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Client) session.get(requests.Client.class, username, lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static List queryClient(PersistentSession session, String condition, String orderBy) throws PersistentException {
		StringBuffer sb = new StringBuffer("From requests.Client as Client");
		if (condition != null)
	...
	public static Client createClient() {
		return new requests.Client();
	}
	
	public static boolean save(requests.Client client) throws PersistentException {
		try {
	...
	public static boolean delete(requests.Client client) throws PersistentException {
		try {
	...
	public static boolean evict(requests.Client client) throws PersistentException {
		try {
