...
public class UserDAO {
	...
	public static User loadUserByORMID(PersistentSession session, String username) throws PersistentException {
		try {
			return (User) session.load(requests.User.class, username);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static User getUserByORMID(PersistentSession session, String username) throws PersistentException {
		try {
			return (User) session.get(requests.User.class, username);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static User loadUserByORMID(PersistentSession session, String username, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (User) session.load(requests.User.class, username, lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static User getUserByORMID(PersistentSession session, String username, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (User) session.get(requests.User.class, username, lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static List queryUser(PersistentSession session, String condition, String orderBy) throws PersistentException {
		StringBuffer sb = new StringBuffer("From requests.User as User");
		if (condition != null)
	...
	public static boolean save(requests.User user) throws PersistentException {
		try {
	...
	public static boolean delete(requests.User user) throws PersistentException {
		try {
	...
	public static boolean refresh(requests.User user) throws PersistentException {
		try {
	...
	public static boolean evict(requests.User user) throws PersistentException {
		try {
