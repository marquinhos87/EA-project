...
public class ClientDAO {
	...
	public static Client loadClientByORMID(PersistentSession session, String username) throws PersistentException {
		try {
			return (Client) session.load(notifications.Client.class, username);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Client getClientByORMID(PersistentSession session, String username) throws PersistentException {
		try {
			return (Client) session.get(notifications.Client.class, username);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Client loadClientByORMID(PersistentSession session, String username, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Client) session.load(notifications.Client.class, username, lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Client getClientByORMID(PersistentSession session, String username, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Client) session.get(notifications.Client.class, username, lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static List queryClient(PersistentSession session, String condition, String orderBy) throws PersistentException {
		StringBuffer sb = new StringBuffer("From notifications.Client as Client");
		if (condition != null)
	...
	public static boolean save(notifications.Client client) throws PersistentException {
		try {
			notifications.DiagramasPersistentManager.instance().saveObject(client);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(notifications.Client client) throws PersistentException {
		try {
			notifications.DiagramasPersistentManager.instance().deleteObject(client);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean refresh(notifications.Client client) throws PersistentException {
		try {
			notifications.DiagramasPersistentManager.instance().getSession().refresh(client);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(notifications.Client client) throws PersistentException {
		try {
			notifications.DiagramasPersistentManager.instance().getSession().evict(client);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
