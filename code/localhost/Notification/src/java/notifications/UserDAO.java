...
public class UserDAO {
	...
	public static User loadUserByORMID(PersistentSession session, String username) throws PersistentException {
		try {
			return (User) session.load(notifications.User.class, username);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static User getUserByORMID(PersistentSession session, String username) throws PersistentException {
		try {
			return (User) session.get(notifications.User.class, username);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static User loadUserByORMID(PersistentSession session, String username, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (User) session.load(notifications.User.class, username, lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static User getUserByORMID(PersistentSession session, String username, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (User) session.get(notifications.User.class, username, lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static List queryUser(PersistentSession session, String condition, String orderBy) throws PersistentException {
		StringBuffer sb = new StringBuffer("From notifications.User as User");
		if (condition != null)
	...
	public static User createUser() {
		return new notifications.User();
	}
	
	public static boolean save(notifications.User user) throws PersistentException {
		try {
			notifications.DiagramasPersistentManager.instance().saveObject(user);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(notifications.User user) throws PersistentException {
		try {
			notifications.DiagramasPersistentManager.instance().deleteObject(user);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean refresh(notifications.User user) throws PersistentException {
		try {
			notifications.DiagramasPersistentManager.instance().getSession().refresh(user);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(notifications.User user) throws PersistentException {
		try {
			notifications.DiagramasPersistentManager.instance().getSession().evict(user);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
